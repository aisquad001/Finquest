...
export const SHOP_ITEMS: ShopItem[] = [
    ...
    { id: 'acc_boba', name: 'Boba Tea', emoji: '🧋', cost: 1800, category: 'cosmetic', tier: 1, description: 'Daily necessity.', cosmeticType: 'accessory', cosmeticValue: '🧋', active: true },
    { id: 'face_skull', name: 'I\'m Dead', emoji: '💀', cost: 2200, category: 'cosmetic', tier: 1, description: 'LMAO ded.', cosmeticType: 'emoji', cosmeticValue: '💀', active: true },
    ...
    { id: 'acc_headphones', name: 'Lofi Vibes', emoji: '🎧', cost: 3000, category: 'cosmetic', tier: 1, description: 'Study beats.', cosmeticType: 'accessory', cosmeticValue: '🎧', active: true },
    ...
    { id: 'face_melting', name: 'It\'s Fine', emoji: '🫠', cost: 6200, category: 'cosmetic', tier: 2, description: 'Everything is fine.', cosmeticType: 'emoji', cosmeticValue: '🫠', active: true },
    ...
    { id: 'bg_vapor', name: 'Vaporwave', emoji: '🌆', cost: 7200, category: 'cosmetic', tier: 2, description: 'A E S T H E T I C.', cosmeticType: 'bg', cosmeticValue: 'bg-gradient-to-br from-pink-500 to-cyan-500', active: true },
    ...
    { id: 'acc_controller', name: 'Pro Gamer', emoji: '🎮', cost: 8800, category: 'cosmetic', tier: 2, description: 'Get gud.', cosmeticType: 'accessory', cosmeticValue: '🎮', active: true },
    ...
    { id: 'face_star', name: 'Main Character', emoji: '🤩', cost: 24000, category: 'cosmetic', tier: 3, description: 'It\'s my movie.', cosmeticType: 'emoji', cosmeticValue: '🤩', active: true },
    ...
    { id: 'fit_drip', name: 'Max Drip', emoji: '🧥', cost: 32000, category: 'cosmetic', tier: 3, description: 'Respect the fit.', cosmeticType: 'outfit', cosmeticValue: '🧥', active: true },
    ...
    { id: 'bg_fire', name: 'Lit Mode', emoji: '🔥', cost: 45000, category: 'cosmetic', tier: 3, description: 'Straight fire.', cosmeticType: 'bg', cosmeticValue: 'bg-gradient-to-t from-red-600 to-yellow-400', active: true },
    ...
    { id: 'bg_rainbow', name: 'RGB Aura', emoji: '🌈', cost: 80000, category: 'cosmetic', tier: 4, description: 'Gamer setup vibes.', cosmeticType: 'bg', cosmeticValue: 'bg-gradient-to-r from-red-500 via-green-500 to-blue-500', active: true },
    ...
    { id: 'face_dragon', name: 'Dragon Energy', emoji: '🐲', cost: 120000, category: 'cosmetic', tier: 4, description: 'Unstoppable.', cosmeticType: 'emoji', cosmeticValue: '🐲', active: true },
